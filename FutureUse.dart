...
/* Difference between then and await:
  ...
  await   : It interrupt the process flow until async method has finished by return the result/error. For the multiple 
...
/*
  ...
  3. Long running task in UI program (like calculating some trick math formula.
	Example: After sorting or filtering the long list of data.
*/


Future<List<String>> getUsers() async{
	List<String> users = List.generate(100, (index) {
		return 'user $index';
	});
